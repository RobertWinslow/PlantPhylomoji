#This is some code copied from http://etetoolkit.org/docs/latest/tutorial/tutorial_drawing.html
...
ts = TreeStyle()
ts.show_leaf_name = True
ts.title.add_face(TextFace("Hello ETE🦆🦬🐃🦤", fsize=5, ftype='OpenMoji'), column=0)
t.show(tree_style=ts)
